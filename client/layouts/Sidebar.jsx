        ...
        <div className="sidebar-inner ">
          <div id="sidebar-menu" className="sidebar-menu sidebar-menu-two">
            <ul>
              ...
              <li
                className={`${
                  "/StateManagement/Onboarding/BranchOffice" === pathName ||
                  "/StateManagement/Pricing/OwnerDetails" === pathName ||
                  "/StateManagement/Dashboard/Activity" === pathName ||
                  "/StateManagement/Visitors/HouseID" === pathName
                    ? "active submenu"
                    : "submenu"
                }`}
              >
                <a href="/StateManagement">
                  <CurrencyBitcoinIcon /> <span>State Management</span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li className={`${"/StateManagement/Onboarding/BranchOffice" === pathName ? "active" : ""}`}>
                    <Link href="/StateManagement/Onboarding/BranchOffice">
                      <a>Estate Setup</a>
                    </Link>
                  </li>
                  <li className={`${"/StateManagement/Dashboard/Activity" === pathName ? "active" : ""}`}>
                    <Link href="/StateManagement/Dashboard/Activity">
                      <a>Activity</a>
                    </Link>
                  </li>
                  <li className={`${"/StateManagement/Visitors/HouseID" === pathName ? "active" : ""}`}>
                    <Link href="/StateManagement/Visitors/HouseID">
                      <a>Visitors</a>
                    </Link>
                  </li>
                  <li className={`${"/StateManagement/Tenant/GuestList" === pathName ? "active" : ""}`}>
                    <Link href="/StateManagement/Tenant/GuestList">
                      <a>Tenant</a>
                    </Link>
                  </li>
                  <li className={`${"/StateManagement/Tenant/GuestList" === pathName ? "active" : ""}`}>
                    <Link href="/StateManagement/Statemgt/Reports">
                      <a >Activity Reports</a>
                    </Link>
                  </li>
                  <li className={`${"/StateManagement/GuestCheckin/Checkin" === pathName ? "active" : ""}`}>
                    <Link href="/StateManagement/GuestCheckin/Checkin">
                      <a >Guest Check In</a>
                    </Link>
                  </li>
                </ul>
              ...
              <li
                className={`${
                  "/BusinessMgt/Property" === pathName ||
                  "/BusinessMgt/Invoice" === pathName ||
                  "/BusinessMgt/Tenant" === pathName ||
                  "/BusinessMgt/Maintainer" === pathName ||
                  "/BusinessMgt/MaintenanceReq" === pathName
                    ? "active submenu"
                    : "submenu"
                }`}
              >
                <a href="/BusinessMgt/Invoice">
                  <CurrencyBitcoinIcon /> <span>Business Management</span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li className={`${"/BusinessMgt/Invoice" === pathName ? "active" : ""}`}>
                    <Link href="/BusinessMgt/Invoice">
                      <a>Invoice</a>
                    </Link> 
                  </li>
                  <li className={`${"/BusinessMgt/Property" === pathName ? "active" : ""}`}>
                    <Link href="/BusinessMgt/Property">
                      <a>Property</a>
                    </Link>
                  </li>
                  <li className={`${"/BusinessMgt/Tenant" === pathName ? "active" : ""}`}>
                    <Link href="/BusinessMgt/Tenant">
                      <a>Tenant</a>
                    </Link>
                  </li>
                  <li className={`${"/BusinessMgt/Maintainers" === pathName ? "active" : ""}`}>
                    <Link href="/BusinessMgt/Maintainers">
                      <a>Maintainer</a>
                    </Link>
                  </li>
                  <li className={`${"/BusinessMgt/MaintainanceReq" === pathName ? "active" : ""}`}>
                    <Link href="/BusinessMgt/MaintainanceReq">
