        ...
        <div className="sidebar-inner ">
          <div id="sidebar-menu" className="sidebar-menu sidebar-menu-two">
            <ul>
              ...
              >
                {/* <Link href="/StateManagement/Onboarding/BranchOffice"></Link> */}
                <a href="#">
                  <FeatherIcon icon="home" /> <span>State Management</span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  ...
                  <li className={`${"StateManagement/Pricing/OwnerDetails" === pathName ? "active" : ""}`}>
                    <Link href="StateManagement/Pricing/OwnerDetails">
                      <a>Pricing</a>
                    </Link>
                  </li>
                </ul>
