        ...
        <div className="">
          ...
          <div className="flex"> 
            ...
            <div className="absolute right-3">
              <Navbar />
              <div className="-mt-[1.3rem] flex justify-center items-center">
              ...
              <div className="flex ">
                <div className="content mt-2 border-1 bg-[#ffff] border-gray-400 rounded-xl p-2 max-w-[34rem] w-full ml-3">
                    <Filter />
                    <div className="container p-2 m-2">
                        <div className="grid grid-cols-5 gap-3 p-2 bg-black rounded-md">
                            <span className="text-white">Guest name</span>
                            <span className="text-white"> Date</span>
                            <span className="text-white">Dateout</span>
                            <span className="text-white">Duration</span>
                            <span className="text-white">Status</span>
                        </div>
                       <div className="border-b-[1px] border-black">
                       {transaction?.map((item, index) => (
                        <div key={index} className={`grid grid-cols-5 ${item?.status === 'Overstay' ? 'bg-gray-300' : ''} gap-3 p-2.5 text-center border-r-[1px] border-l-[1px] border-black`}><span style={{width: "6rem"}} className="text-black">{item?.name}</span>
