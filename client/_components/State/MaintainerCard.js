...
const MaintainerCard = ({ icon, name, email, icon2, icon3, info, address, phone, property, type, s_date }) => {
    return (
        <div style={{width: '100%', maxWidth: '26rem'}} className=' bg-[#ffff] p-2 rounded-md m-2'>
            ...
            <div className="info p-1 ml-2 pl-2">
                <div className="flex items-center">
                    ...
                    <p style={{color: '#1a7cbc'}} className='text-lg text-blue-800 font-bold'>{info}</p>
                </div>
                ...
                <p className='text-base text-black font-semibold'>Type:<span className='text-gray-400'> {type}</span></p>
